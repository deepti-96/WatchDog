...
- Real: Rust detection engine, CUSUM metric shift detection, deploy correlation, log signature extraction, Supabase/SQLite/JSON incident persistence, notes/status updates, exports, health endpoint, and dashboard APIs.
